            ...
            <ul class="nav navbar-nav">
                ...
                @if (Auth::user()->regCodeVerified  !== 0)
                    @if(auth()->user()->hasRole('Owner'))
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fas fa-user"></i>New Site</a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fas fa-user"></i><a href="http://www.afterearthcluster.com/testing/dev">Create Store</a></li>
