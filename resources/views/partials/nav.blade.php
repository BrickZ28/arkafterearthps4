<nav class="navbar top-bar navbar-static-top sps sps--abv">
    <div class="container relative-box "> <a class="navbar-brand" href="#">Afterearth</a><img src="{{asset('/img/AE-75.png')}}" alt="" height="50" width="50"><img src="{{asset('/img/home/warboat_ticket.png')}}" alt="" height="75" width="150">
